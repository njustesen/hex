...
public class PathfindingTests
{
    ...
    public void FlatMap_ReachableTiles_Marine()
    {
        ...
        start.Unit = new Unit(UnitType.Marine); // 2 MP

        var reachable = Pathfinding.GetReachableTiles(map, start, 2, UnitType.Marine);
    ...
    public void FlatMap_ReachableTiles_Tank_MoreRange()
    {
        var map = CreateFlatMap();
        var start = map.Tiles[5][5];
        start.Unit = new Unit(UnitType.Tank); // 3 MP

        var reachableTank = Pathfinding.GetReachableTiles(map, start, 3, UnitType.Tank);
        var reachableMarine = Pathfinding.GetReachableTiles(map, start, 2, UnitType.Marine);
    ...
    public void FighterIgnores_Elevation()
    {
        var map = CreateFlatMap();
        var start = map.Tiles[5][5];
        start.Unit = new Unit(UnitType.Fighter);
        ...
        var reachable = Pathfinding.GetReachableTiles(map, start, 4, UnitType.Fighter);
        Assert.NotEmpty(reachable);
    }
    ...
    public void OccupiedTile_ExcludedFromReachable()
    {
        ...
        var neighbor = map.GetNeighbor(start, 0)!;
        neighbor.Unit = new Unit(UnitType.Tank);
    ...
    public void OccupiedTile_Passable_ForTraversal()
    {
        ...
        var neighbor = map.GetNeighbor(start, 0)!;
        neighbor.Unit = new Unit(UnitType.Marine);

        // There should be tiles reachable beyond the occupied neighbor
        var reachable = Pathfinding.GetReachableTiles(map, start, 3, UnitType.Tank);
    ...
    public void FindPath_FlatMap_ReturnsPath()
    {
        ...
        var path = Pathfinding.FindPath(map, start, goal, UnitType.Marine);
        Assert.NotNull(path);
    ...
    public void FindPath_OccupiedGoal_ReturnsNull()
    {
        ...
        var start = map.Tiles[5][5];
        var goal = map.GetNeighbor(start, 0)!;
        goal.Unit = new Unit(UnitType.Marine);
    ...
    public void CanTraverse_SameElevation_True()
    {
        ...
        Assert.True(Pathfinding.CanTraverse(a, b, 0, map, UnitType.Marine));
    }
    ...
    public void CanTraverse_DifferentElevation_NoRamp_False()
    {
        ...
        var b = map.GetNeighbor(a, 0)!;
        b.Elevation = 2;
        Assert.False(Pathfinding.CanTraverse(a, b, 0, map, UnitType.Marine));
    }
    ...
    public void CanTraverse_Fighter_AlwaysTrue()
    {
        ...
        var b = map.GetNeighbor(a, 0)!;
        b.Elevation = 5;
        Assert.True(Pathfinding.CanTraverse(a, b, 0, map, UnitType.Fighter));
    }
}
