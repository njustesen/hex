...
public static class Colors
{
    ...
    public static readonly Color DARK_GREY = new Color(75, 75, 75);
    public static readonly Color VERY_DARK_GREY = new Color(25, 25, 25);
    ...
    // CSS4 named colors (subset matching matplotlib CSS4_COLORS)
    public static readonly Dictionary<string, Color> NamedColors = new Dictionary<string, Color>
    {
